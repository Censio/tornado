...
from censiotornado.concurrent import TracebackFuture
from censiotornado.escape import utf8, native_str, to_unicode
from censiotornado import httpclient, httputil
from censiotornado.ioloop import IOLoop
from censiotornado.iostream import StreamClosedError
from censiotornado.log import gen_log, app_log
from censiotornado import simple_httpclient
from censiotornado.tcpclient import TCPClient
from censiotornado.util import _websocket_mask, PY3
...
class WebSocketHandler(censiotornado.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        if self.ws_connection:
            ...
            if not self.stream.closed():
                self.stream.write(censiotornado.escape.utf8(
    ...
    def write_message(self, message, binary=False):
        ...
        if isinstance(message, dict):
            message = censiotornado.escape.json_encode(message)
...
class _PerMessageDeflateCompressor(object):
    ...
    def _create_compressor(self):
        return zlib.compressobj(censiotornado.web.GZipContentEncoding.GZIP_LEVEL,
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(self, message, binary=False):
        ...
        if binary:
            ...
            opcode = 0x1
        message = censiotornado.escape.utf8(message)
