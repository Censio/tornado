...
def import_object(name):
    ...
    >>> import_object('censiotornado.escape') is censiotornado.escape
    True
    >>> import_object('censiotornado.escape.utf8') is censiotornado.escape.utf8
    True
    >>> import_object('censiotornado') is censiotornado
    True
    >>> import_object('censiotornado.missing_module')
...
if (os.environ.get('TORNADO_NO_EXTENSION') or
    ...
    try:
        from censiotornado.speedups import websocket_mask as _websocket_mask
    except ImportError:
