...
from censiotornado import iostream
from censiotornado import locale
from censiotornado.log import access_log, app_log, gen_log
from censiotornado import stack_context
from censiotornado import template
from censiotornado.escape import utf8, _unicode
from censiotornado.util import (import_object, ObjectDict, raise_exc_info,
                                unicode_type, _websocket_mask, re_unescape, PY3)
from censiotornado.httputil import split_host_and_port
...
class Application(httputil.HTTPServerConnectionDelegate):
    ...
    def __init__(self, handlers=None, default_host="", transforms=None,
        ...
        if self.settings.get('autoreload'):
            from censiotornado import autoreload
            autoreload.start()
