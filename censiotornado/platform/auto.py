...
if 'APPENGINE_RUNTIME' in os.environ:
    from censiotornado.platform.common import Waker

    def set_close_exec(fd):
        pass
elif os.name == 'nt':
    from censiotornado.platform.common import Waker
    from censiotornado.platform.windows import set_close_exec
else:
    from censiotornado.platform.posix import set_close_exec, Waker
