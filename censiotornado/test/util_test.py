...
from censiotornado.escape import utf8
from censiotornado.util import raise_exc_info, Configurable, exec_in, ArgReplacer, timedelta_to_seconds, import_object, re_unescape, PY3
...
class ImportObjectTest(unittest.TestCase):
    def test_import_member(self):
        self.assertIs(import_object('censiotornado.escape.utf8'), utf8)

    def test_import_member_unicode(self):
        self.assertIs(import_object(u'censiotornado.escape.utf8'), utf8)

    def test_import_module(self):
        self.assertIs(import_object('censiotornado.escape'), censiotornado.escape)

    def test_import_module_unicode(self):
        # The internal implementation of __import__ differs depending on
        # whether the thing being imported is a module or not.
        # This variant requires a byte string in python 2.
        self.assertIs(import_object(u'censiotornado.escape'), censiotornado.escape)
