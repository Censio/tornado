...
from censiotornado.platform.auto import set_close_exec
from censiotornado.platform.select import SelectIOLoop
from censiotornado.testing import bind_unused_port
from censiotornado.test.util import unittest
from censiotornado.util import import_object, PY3
...
try:
    ...
    from censiotornado.platform.twisted import TornadoReactor, TwistedIOLoop
