...
from censiotornado.escape import json_decode, utf8, to_unicode, recursive_unicode, native_str, to_basestring
from censiotornado.httputil import format_timestamp
from censiotornado.ioloop import IOLoop
from censiotornado.iostream import IOStream
from censiotornado import locale
from censiotornado.log import app_log, gen_log
from censiotornado.simple_httpclient import SimpleAsyncHTTPClient
from censiotornado.template import DictLoader
from censiotornado.testing import AsyncHTTPTestCase, AsyncTestCase, ExpectLog, gen_test
from censiotornado.test.util import unittest, skipBefore35, exec_test
from censiotornado.util import ObjectDict, unicode_type, timedelta_to_seconds, PY3
from censiotornado.web import RequestHandler, authenticated, Application, asynchronous, url, HTTPError, StaticFileHandler, _create_signature_v1, create_signed_value, decode_signed_value, ErrorHandler, UIModule, MissingArgumentError, stream_request_body, Finish, removeslash, addslash, RedirectHandler as WebRedirectHandler, get_signature_key_version, GZipContentEncoding
...
class HandlerByNameTest(WebTestCase):
    def get_handlers(self):
        ...
        return [('/hello1', HelloHandler),
                ('/hello2', 'censiotornado.test.web_test.HelloHandler'),
                url('/hello3', 'censiotornado.test.web_test.HelloHandler'),
                ]
