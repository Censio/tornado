...
from censiotornado.log import LogFormatter, define_logging_options, enable_pretty_logging
from censiotornado.options import OptionParser
from censiotornado.test.util import unittest
from censiotornado.util import basestring_type
...
class EnablePrettyLoggingTest(unittest.TestCase):
    def setUp(self):
        ...
        self.logger = logging.Logger('censiotornado.test.log_test.EnablePrettyLoggingTest')
        self.logger.propagate = False
...
class LoggingOptionTest(unittest.TestCase):
    ...
    def logs_present(self, statement, args=None):
        ...
        # ran.
        IMPORT = 'from censiotornado.options import options, parse_command_line'
