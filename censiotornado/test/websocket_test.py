...
from censiotornado.httpclient import HTTPError, HTTPRequest
from censiotornado.log import gen_log, app_log
from censiotornado.testing import AsyncHTTPTestCase, gen_test, bind_unused_port, ExpectLog
from censiotornado.test.util import unittest
from censiotornado.web import Application, RequestHandler

try:
    import censiotornado.websocket  # noqa
    from censiotornado.util import _websocket_mask_python
except ImportError:
...
from censiotornado.websocket import WebSocketHandler, websocket_connect, WebSocketError

try:
    from censiotornado import speedups
except ImportError:
    speedups = None
