...
from censiotornado.concurrent import Future, TracebackFuture, is_future, chain_future
from censiotornado.ioloop import IOLoop
from censiotornado.log import app_log
from censiotornado import stack_context
from censiotornado.util import PY3, raise_exc_info
...
if singledispatch is not None:
    ...
    try:
        ...
        import censiotornado.platform.asyncio
    except ImportError:
        pass
    else:
